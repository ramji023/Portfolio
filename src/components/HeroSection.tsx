      ...
      >
        <div className="gap-8 items-center">
          ...
          <div>
            ...
            <h1 className="text-6xl font-extrabold leading-tight text-text-other ">
              Full-Stack Web Developer
            </h1>
            <h1 className="text-5xl font-extrabold leading-tight text-text-primary">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              ...
              target="_blank"
              className="inline-flex text-md items-center gap-2 px-4 py-2 rounded-md border border-border-other text-text-other shadow-md hover:scale-[1.02] transition-transform"
            >
              <i
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-sm">
            {[
              ...
              <div
                key={tag}
                className="px-4 py-2 text-text-other/80 bg-text-other/10 rounded-4xl hover:scale-[1.02] transition-transform hover:text-text-other"
              >
                {tag}
              </div>
            ))}
